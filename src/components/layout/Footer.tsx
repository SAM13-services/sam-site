...
export default function Footer() {
  ...
  return (
    <footer className="bg-white border-t border-gray-200">
      <div className="px-4 md:px-[50px] pt-12 pb-6">

        {/* Top — Logo massif + colonnes */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-6 mb-10 lg:mb-8">

          {/* Logo grand */}
          <div className="lg:col-span-5">
            <Link to="/" className="inline-block group">
              <img src="/LOGO copie.svg" alt="SAM" className="h-16 w-auto group-hover:opacity-80 transition-opacity duration-200 lg:mb-3" />
              <span className="hidden lg:block text-sm text-gray-400 max-w-xs leading-relaxed">
                {"Service d'Accompagnement aux Subventions Professionnelles"}
              </span>
            </Link>
          </div>

          {/* Navigation + Contact — 2 colonnes mobile, grid 12-col desktop intact */}
